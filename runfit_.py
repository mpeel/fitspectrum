...
fitspectrum('seds/m31_dx11d.txt',srcname="M31",outdir='sedfits/',format=1,maxfitfreq=2000,mcmc=True,nosync=False,nofreefree=False,noame=False,nocmb=False,nodust=False,nodust2=True)
