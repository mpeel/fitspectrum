...
plotspectrum(outdir='', name='cbass_quijote_groundbird', maps=maps_I, mask_min=mask_min,mask_max=mask_max,spd_file='amemodels/spdust2_cnm.dat',minfreq=0.2,maxfreq=2000.0,numxpoints=1000,ymin=1,ymax=5e7,nosync=False,nofreefree=False,noame=False,nocmb=False,nodust=False,nodust2=True,freqbands=freqbands_I,nside=256,res=60.0,pol=False)

# plotspectrum(outdir='', name='cbass_fig1_reproPlanck', maps=maps_I, mask_min=mask_min,mask_max=mask_max,spd_file='amemodels/spdust2_cnm.dat',minfreq=10,maxfreq=1300.0,numxpoints=1000,ymin=2e-2,ymax=8e2,nosync=False,nofreefree=False,noame=False,nocmb=False,nodust=False,nodust2=True,freqbands=freqbands_I,nside=256,res=60.0,pol=False,legend=False)

# mask_min=[['commander2015/wmap_polarization_analysis_mask_r8_9yr_v5_trim.fits',250,0]]

plotspectrum(outdir='', name='cbass_quijote_groundbird_pol', maps=maps_P, mask_min=mask_min,mask_max=mask_max,spd_file='amemodels/spdust2_cnm.dat',minfreq=0.2,maxfreq=2000.0,numxpoints=1000,ymin=0.1,ymax=5e6,nosync=False,nofreefree=False,noame=False,nocmb=False,nodust=False,nodust2=True,freqbands=freqbands_P,nside=256,res=60.0,pol=True)

# plotspectrum(outdir='', name='cbass_fig1_pol_reproPlanck', maps=maps_P, mask_min=mask_min,mask_max=mask_max,spd_file='amemodels/spdust2_cnm.dat',minfreq=10,maxfreq=1300.0,numxpoints=1000,ymin=2e-2,ymax=8e2,nosync=False,nofreefree=False,noame=False,nocmb=False,nodust=False,nodust2=True,freqbands=freqbands_P,nside=256,res=60.0,pol=True,legend=False)