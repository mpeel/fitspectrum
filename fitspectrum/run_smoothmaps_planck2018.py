...
smoothmap(directory,directory,'LFI_SkyMap_030-BPassCorrected_1024_R3.00_full.fits','256_60.00smoothed_PlanckR3fullbeam_28.4_1024_2018_KCMBunits.fits', output_resolution,nside_out=output_nside,outputmaps=[0,4],windowfunction=beamtf_p30)
smoothmap(directory,directory,'LFI_SkyMap_044-BPassCorrected_1024_R3.00_full.fits','256_60.00smoothed_PlanckR3fullbeam_44.1_1024_2018_KCMBunits.fits', output_resolution,nside_out=output_nside,outputmaps=[0,4],windowfunction=beamtf_p44)
smoothmap(directory,directory,'LFI_SkyMap_070-BPassCorrected_1024_R3.00_full.fits','256_60.00smoothed_PlanckR3fullbeam_70.4_1024_2018_KCMBunits.fits', output_resolution,nside_out=output_nside,outputmaps=[0,4],windowfunction=beamtf_p70)
