...
# smoothmap(directory,directory,'LFI_SkyMap_030-BPassCorrected_1024_R3.00_full.fits','256_60.00smoothed_PlanckR3full_28.4_1024_2018_KCMBunits.fits', np.sqrt(output_resolution**2-(33.16)**2),nside_out=output_nside,outputmaps=[0,4])
# smoothmap(directory,directory,'LFI_SkyMap_044-BPassCorrected_1024_R3.00_full.fits','256_60.00smoothed_PlanckR3full_44.1_1024_2018_KCMBunits.fits', np.sqrt(output_resolution**2-(28.09)**2),nside_out=output_nside,outputmaps=[0,4])
# smoothmap(directory,directory,'LFI_SkyMap_070-BPassCorrected_1024_R3.00_full.fits','256_60.00smoothed_PlanckR3full_70.4_1024_2018_KCMBunits.fits', np.sqrt(output_resolution**2-(13.08)**2),nside_out=output_nside,outputmaps=[0,4])
...
# smoothmap(directory,directory,'HFI_SkyMap_353-psb_2048_R3.00_full.fits','256_60.00smoothed_PlanckR3full_353_2048_2018_KCMBunits.fits', np.sqrt(output_resolution**2-4.7**2),nside_out=output_nside,outputmaps=[0,4])
...
smoothmap(directory,directory,'LFI_SkyMap_030-BPassCorrected__1024_R3.00_full.fits','256_60.00smoothed_PlanckR3fullbeam_28.4_1024_2018_KCMBunits.fits', output_resolution,nside_out=output_nside,outputmaps=[0,4],windowfunction=beamtf_p30)
smoothmap(directory,directory,'LFI_SkyMap_044-BPassCorrected__1024_R3.00_full.fits','256_60.00smoothed_PlanckR3fullbeam_44.1_1024_2018_KCMBunits.fits', output_resolution,nside_out=output_nside,outputmaps=[0,4],windowfunction=beamtf_p44)
smoothmap(directory,directory,'LFI_SkyMap_070-BPassCorrected__1024_R3.00_full.fits','256_60.00smoothed_PlanckR3fullbeam_70.4_1024_2018_KCMBunits.fits', output_resolution,nside_out=output_nside,outputmaps=[0,4],windowfunction=beamtf_p70)
...
smoothmap(directory,directory,'HFI_SkyMap_353-psb_2048_R3.00_full.fits','256_60.00smoothed_PlanckR3fullbeam_353_2048_2018_KCMBunits.fits', output_resolution,nside_out=output_nside,outputmaps=[0,4],windowfunction=beamtf_p353)
