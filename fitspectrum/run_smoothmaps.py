...
smoothmap(directory+'LFI_SkyMap_030_1024_R2.01_full.fits',directory+'256_60.00smoothed_LFI_30_256_PR2.01.fits',np.sqrt(output_resolution**2-34.2**2),nside_out=output_nside)#,units_out='mK_RJ')
