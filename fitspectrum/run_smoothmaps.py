...
for i in range(0,numnside):
	...
	smoothmap(directory,outdirectory,'LFI_SkyMap_030_1024_R2.01_full.fits',str(output_nside[i])+'_60.00smoothed_PlanckR2fullbeam_28.4_1024_2015_KCMBunits.fits', output_resolution,nside_out=output_nside[i],outputmaps=[0,4],windowfunction=beamtf_p30,maxnummaps=1,appendmap=directory+str(output_nside[i])+'_60.00smoothed_wmap9beam_93.5_512_2013_mKCMBunits_variance.fits',appendmapname="II_cov",appendmapunit="(mK)^2")
	smoothmap(directory,outdirectory,'LFI_SkyMap_044_1024_R2.01_full.fits',str(output_nside[i])+'_60.00smoothed_PlanckR2fullbeam_44.1_1024_2015_KCMBunits.fits', output_resolution,nside_out=output_nside[i],outputmaps=[0,4],windowfunction=beamtf_p44)
	smoothmap(directory,outdirectory,'LFI_SkyMap_070_1024_R2.01_full.fits',str(output_nside[i])+'_60.00smoothed_PlanckR2fullbeam_70.4_1024_2015_KCMBunits.fits', output_resolution,nside_out=output_nside[i],outputmaps=[0,4],windowfunction=beamtf_p70)
