...
smoothmap(directory,directory,'wmap_band_smth_deconv_imap_r9_9yr_K_v5.fits','256_60.00smoothed_wmap9decbeam_22.8_512_2013_mKCMBunits.fits', output_resolution,nside_out=output_nside,sigma_0=1.429,sigma_0_unit='mK',nosmooth=[0],windowfunction=beamtf_K)
smoothmap(directory,directory,'wmap_band_deconv_imap_r9_9yr_Ka_v5.fits','256_60.00smoothed_wmap9decbeam_33.0_512_2013_mKCMBunits.fits', output_resolution,nside_out=output_nside,sigma_0=1.466,sigma_0_unit='mK',nosmooth=[0],windowfunction=beamtf_Ka)
