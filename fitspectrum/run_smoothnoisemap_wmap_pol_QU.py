...
outdirectory = directory+"wmap9_tqu_noise_QU/"
# Read in the beams
...
for i in range(0,len(output_resolution)):
	...
	sigma_0 = 1.429 # mK
	sigma_P = 1.435 # mK
	smoothnoisemap(directory+'/wmap9/', outdirectory, str(output_resolution[i])+'smoothed_wmap9beam_22.8_512_2013_mKCMBunits_'+str(mapnumbers[m])+'.fits', 'wmap_band_iqumap_r9_9yr_K_v5.fits',mapnumber=mapnumbers,numrealisations=numrealisations,fwhm=output_resolution[i],windowfunction=beamtf_K,sigma_0=sigma_0,sigma_P=sigma_P,nside=output_nside,hdu=hdu,do_intensity=True,do_polarisation=True,units_out=units_out)

	sigma_0 = 1.466 # mK
	sigma_P = 1.472 # mk
	smoothnoisemap(directory+'/wmap9/', outdirectory, str(output_resolution[i])+'smoothed_wmap9beam_33.0_512_2013_mKCMBunits_'+str(mapnumbers[m])+'.fits', 'wmap_band_iqumap_r9_9yr_Ka_v5.fits',mapnumber=mapnumbers,numrealisations=numrealisations,fwhm=output_resolution[i],windowfunction=beamtf_Ka,sigma_0=sigma_0,sigma_P=sigma_P,nside=output_nside,hdu=hdu,do_intensity=True,do_polarisation=True,units_out=units_out)

	sigma_0 = 2.188 # mK
	sigma_P = 2.197 # mK
	smoothnoisemap(directory+'/wmap9/', outdirectory, str(output_resolution[i])+'smoothed_wmap9beam_40.7_512_2013_mKCMBunits_'+str(mapnumbers[m])+'.fits', 'wmap_band_iqumap_r9_9yr_Q_v5.fits',mapnumber=mapnumbers,numrealisations=numrealisations,fwhm=output_resolution[i],windowfunction=beamtf_Q,sigma_0=sigma_0,sigma_P=sigma_P,nside=output_nside,hdu=hdu,do_intensity=True,do_polarisation=True,units_out=units_out)

	sigma_0 = 3.131 # mK
	sigma_P = 3.141 # mK
	smoothnoisemap(directory+'/wmap9/', outdirectory, str(output_resolution[i])+'smoothed_wmap9beam_60.7_512_2013_mKCMBunits_'+str(mapnumbers[m])+'.fits', 'wmap_band_iqumap_r9_9yr_V_v5.fits',mapnumber=mapnumbers,numrealisations=numrealisations,fwhm=output_resolution[i],windowfunction=beamtf_V,sigma_0=sigma_0,sigma_P=sigma_P,nside=output_nside,hdu=hdu,do_intensity=True,do_polarisation=True,units_out=units_out)

	sigma_0 = 6.544 # mK
	sigma_P = 6.560 # mK
	smoothnoisemap(directory+'/wmap9/', outdirectory, str(output_resolution[i])+'smoothed_wmap9beam_93.5_512_2013_mKCMBunits_'+str(mapnumbers[m])+'.fits', 'wmap_band_iqumap_r9_9yr_W_v5.fits',mapnumber=mapnumbers,numrealisations=numrealisations,fwhm=output_resolution[i],windowfunction=beamtf_W,sigma_0=sigma_0,sigma_P=sigma_P,nside=output_nside,hdu=hdu,do_intensity=True,do_polarisation=True,units_out=units_out)
