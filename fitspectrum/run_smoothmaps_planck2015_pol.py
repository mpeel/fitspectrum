...
for i in range(0,numnside):
	...
	for j in range(0,numsubtract):
		...
		smoothmap(directory+'wmap9/',outdirectory,'wmap_band_iqumap_r9_9yr_K_v5.fits',str(output_nside[i])+'_'+str(output_resolution)+'smoothed_wmap9beam'+subtractmaps_name[j]+'_22.8_512_20132015_mKCMBunits.fits', output_resolution,nside_out=output_nside[i],sigma_0=1.429,sigma_0_unit='mK',windowfunction=beamtf_K,subtractmap=subtractmaps[j])#,maxnummaps=1,appendmap=directory+str(output_nside[i])+'_60.00smoothed_wmap9beam_22.8_512_2013_mKCMBunits_variance.fits',appendmapname="II_cov",appendmapunit="(mK)^2"
		smoothmap(directory+'wmap9/',outdirectory,'wmap_band_iqumap_r9_9yr_Ka_v5.fits',str(output_nside[i])+'_'+str(output_resolution)+'smoothed_wmap9beam'+subtractmaps_name[j]+'_33.0_512_20132015_mKCMBunits.fits', output_resolution,nside_out=output_nside[i],sigma_0=1.466,sigma_0_unit='mK',windowfunction=beamtf_Ka,subtractmap=subtractmaps[j])#,maxnummaps=1,appendmap=directory+str(output_nside[i])+'_60.00smoothed_wmap9beam_33.0_512_2013_mKCMBunits_variance.fits',appendmapname="II_cov",appendmapunit="(mK)^2"
		smoothmap(directory+'wmap9/',outdirectory,'wmap_band_iqumap_r9_9yr_Q_v5.fits',str(output_nside[i])+'_'+str(output_resolution)+'smoothed_wmap9beam'+subtractmaps_name[j]+'_40.7_512_20132015_mKCMBunits.fits', output_resolution,nside_out=output_nside[i],sigma_0=2.188,sigma_0_unit='mK',windowfunction=beamtf_Q,subtractmap=subtractmaps[j])#,maxnummaps=1,appendmap=directory+str(output_nside[i])+'_60.00smoothed_wmap9beam_40.7_512_2013_mKCMBunits_variance.fits',appendmapname="II_cov",appendmapunit="(mK)^2"
		smoothmap(directory+'wmap9/',outdirectory,'wmap_band_iqumap_r9_9yr_V_v5.fits',str(output_nside[i])+'_'+str(output_resolution)+'smoothed_wmap9beam'+subtractmaps_name[j]+'_60.7_512_20132015_mKCMBunits.fits', output_resolution,nside_out=output_nside[i],sigma_0=3.131,sigma_0_unit='mK',windowfunction=beamtf_V,subtractmap=subtractmaps[j])#,maxnummaps=1,appendmap=directory+str(output_nside[i])+'_60.00smoothed_wmap9beam_60.7_512_2013_mKCMBunits_variance.fits',appendmapname="II_cov",appendmapunit="(mK)^2"
		smoothmap(directory+'wmap9/',outdirectory,'wmap_band_iqumap_r9_9yr_W_v5.fits',str(output_nside[i])+'_'+str(output_resolution)+'smoothed_wmap9beam'+subtractmaps_name[j]+'_93.5_512_20132015_mKCMBunits.fits', output_resolution,nside_out=output_nside[i],sigma_0=6.544,sigma_0_unit='mK',windowfunction=beamtf_W,subtractmap=subtractmaps[j])#,maxnummaps=1,appendmap=directory+str(output_nside[i])+'_60.00smoothed_wmap9beam_93.5_512_2013_mKCMBunits_variance.fits',appendmapname="II_cov",appendmapunit="(mK)^2"

		# smoothmap(directory,outdirectory,'LFI_SkyMap_030-BPassCorrected_1024_R3.00_full.fits',str(output_nside[i])+'_60.00smoothed_PlanckR3full_28.4_1024_2015_KCMBunits.fits', np.sqrt(output_resolution**2-(33.16)**2),nside_out=output_nside[i],outputmaps=[0,4])
		# smoothmap(directory,outdirectory,'LFI_SkyMap_044-BPassCorrected_1024_R3.00_full.fits',str(output_nside[i])+'_60.00smoothed_PlanckR3full_44.1_1024_2015_KCMBunits.fits', np.sqrt(output_resolution**2-(28.09)**2),nside_out=output_nside[i],outputmaps=[0,4])
		# smoothmap(directory,outdirectory,'LFI_SkyMap_070-BPassCorrected_1024_R3.00_full.fits',str(output_nside[i])+'_60.00smoothed_PlanckR3full_70.4_1024_2015_KCMBunits.fits', np.sqrt(output_resolution**2-(13.08)**2),nside_out=output_nside[i],outputmaps=[0,4])
		# smoothmap(directory,outdirectory,'HFI_SkyMap_100_2048_R3.00_full.fits',str(output_nside[i])+'_60.00smoothed_PlanckR3full_100_2048_2015_KCMBunits.fits', np.sqrt(output_resolution**2-9.59**2),nside_out=output_nside[i],outputmaps=[0,4])
		# smoothmap(directory,outdirectory,'HFI_SkyMap_143_2048_R3.00_full.fits',str(output_nside[i])+'_60.00smoothed_PlanckR3full_143_2048_2015_KCMBunits.fits', np.sqrt(output_resolution**2-7.18**2),nside_out=output_nside[i],outputmaps=[0,4])
		# smoothmap(directory,outdirectory,'HFI_SkyMap_217_2048_R3.00_full.fits',str(output_nside[i])+'_60.00smoothed_PlanckR3full_217_2048_2015_KCMBunits.fits', np.sqrt(output_resolution**2-4.87**2),nside_out=output_nside[i],outputmaps=[0,4])
		# smoothmap(directory,outdirectory,'HFI_SkyMap_353_2048_R3.00_full.fits',str(output_nside[i])+'_60.00smoothed_PlanckR3full_353_2048_2015_KCMBunits.fits', np.sqrt(output_resolution**2-4.7**2),nside_out=output_nside[i],outputmaps=[0,4])
		# smoothmap(directory,outdirectory,'HFI_SkyMap_545_2048_R3.00_full.fits',str(output_nside[i])+'_60.00smoothed_PlanckR3full_545_2048_2015_MJySrunits.fits', np.sqrt(output_resolution**2-4.73**2),nside_out=output_nside[i],outputmaps=[0,2])
		# smoothmap(directory,outdirectory,'HFI_SkyMap_857_2048_R3.00_full.fits',str(output_nside[i])+'_60.00smoothed_PlanckR3full_857_2048_2015_MJySrunits.fits', np.sqrt(output_resolution**2-4.51**2),nside_out=output_nside[i],outputmaps=[0,2])

		smoothmap(directory+'planck2015/',outdirectory,'LFI_SkyMap_030_1024_R2.01_full.fits',str(output_nside[i])+'_'+str(output_resolution)+'smoothed_PlanckR3fullbeam'+subtractmaps_name[j]+'_28.4_1024_2015_mKCMBunits.fits', output_resolution,nside_out=output_nside[i],windowfunction=beamtf_p30,units_out='mKCMB',subtractmap=subtractmaps[j])#,appendmap=directory+str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam_28.4_1024_2015_mKCMBunits_variance.fits',appendmapname="II_cov",appendmapunit="(mK)^2"

		smoothmap(directory+'planck2015/',outdirectory,'LFI_SkyMap_044_1024_R2.01_full.fits',str(output_nside[i])+'_'+str(output_resolution)+'smoothed_PlanckR3fullbeam'+subtractmaps_name[j]+'_44.1_1024_2015_mKCMBunits.fits', output_resolution,nside_out=output_nside[i],windowfunction=beamtf_p44,units_out='mKCMB',subtractmap=subtractmaps[j])#,maxnummaps=1,appendmap=directory+str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam_44.1_1024_2015_mKCMBunits_variance.fits',appendmapname="II_cov",appendmapunit="(mK)^2"
		smoothmap(directory+'planck2015/',outdirectory,'LFI_SkyMap_070_2048_R2.01_full.fits',str(output_nside[i])+'_'+str(output_resolution)+'smoothed_PlanckR3fullbeam'+subtractmaps_name[j]+'_70.4_1024_2015_mKCMBunits.fits', output_resolution,nside_out=output_nside[i],windowfunction=beamtf_p70,units_out='mKCMB',subtractmap=subtractmaps[j])#,maxnummaps=1,appendmap=directory+str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam_70.4_1024_2015_mKCMBunits_variance.fits',appendmapname="II_cov",appendmapunit="(mK)^2"
		smoothmap(directory+'planck2015/',outdirectory,'HFI_SkyMap_100_2048_R2.02_full.fits',str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam'+subtractmaps_name[j]+'_100_2048_2015_mKCMBunits.fits', output_resolution,nside_out=output_nside[i],windowfunction=beamtf_p100,units_out='mKCMB',subtractmap=subtractmaps[j])#,maxnummaps=1,appendmap=directory+str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam_100_1024_2015_mKCMBunits_variance.fits',appendmapname="II_cov",appendmapunit="(mK)^2")
		smoothmap(directory+'planck2015/',outdirectory,'HFI_SkyMap_143_2048_R2.02_full.fits',str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam'+subtractmaps_name[j]+'_143_2048_2015_mKCMBunits.fits', output_resolution,nside_out=output_nside[i],windowfunction=beamtf_p143,units_out='mKCMB',subtractmap=subtractmaps[j])#,maxnummaps=1,appendmap=directory+str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam_143_1024_2015_mKCMBunits_variance.fits',appendmapname="II_cov",appendmapunit="(mK)^2"
		smoothmap(directory+'planck2015/',outdirectory,'HFI_SkyMap_217_2048_R2.02_full.fits',str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam'+subtractmaps_name[j]+'_217_2048_2015_mKCMBunits.fits', output_resolution,nside_out=output_nside[i],windowfunction=beamtf_p217,units_out='mKCMB',subtractmap=subtractmaps[j])#maxnummaps=1,appendmap=directory+str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam_217_1024_2015_mKCMBunits_variance.fits',appendmapname="II_cov",appendmapunit="(mK)^2"
		smoothmap(directory+'planck2015/',outdirectory,'HFI_SkyMap_353_2048_R2.02_full.fits',str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam'+subtractmaps_name[j]+'_353_2048_2015_mKCMBunits.fits', output_resolution,nside_out=output_nside[i],windowfunction=beamtf_p353,units_out='mKCMB',subtractmap=subtractmaps[j])#,maxnummaps=1,appendmap=directory+str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam_353_1024_2015_mKCMBunits_variance.fits',appendmapname="II_cov",appendmapunit="(mK)^2"
		if j == 5:
			smoothmap(directory+'planck2015/',outdirectory,'HFI_SkyMap_545_2048_R2.02_full.fits',str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam'+subtractmaps_name[j]+'_545_2048_2015_MJySrunits.fits', output_resolution,nside_out=output_nside[i],windowfunction=beamtf_p545,maxnummaps=1)#,appendmap=directory+str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam_545_1024_2015_MJySrunits_variance.fits',appendmapname="II_cov",appendmapunit="(MJySr)^2")
			smoothmap(directory+'planck2015/',outdirectory,'HFI_SkyMap_857_2048_R2.02_full.fits',str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam'+subtractmaps_name[j]+'_857_2048_2015_MJySrunits.fits', output_resolution,nside_out=output_nside[i],windowfunction=beamtf_p857,maxnummaps=1)#,appendmap=directory+str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam_857_1024_2015_MJySrunits_variance.fits',appendmapname="II_cov",appendmapunit="(MJySr)^2")
