...
smoothmap(directory+'LFI_SkyMap_044_1024_R2.01_full.fits',directory+'256_60.00smoothed_PlanckR2fullbeam_44.1_1024_2015_KCMBunits.fits', output_resolution,nside_out=output_nside,outputmaps=[0,4],windowfunction=beamtf_p44)
smoothmap(directory+'LFI_SkyMap_070_1024_R2.01_full.fits',directory+'256_60.00smoothed_PlanckR2fullbeam_70.4_1024_2015_KCMBunits.fits', output_resolution,nside_out=output_nside,outputmaps=[0,4],windowfunction=beamtf_p70)
smoothmap(directory+'HFI_SkyMap_100_2048_R2.02_full.fits',directory+'256_60.00smoothed_PlanckR2fullbeam_100_2048_2015_KCMBunits.fits', output_resolution,nside_out=output_nside,outputmaps=[0,4],windowfunction=beamtf_p100)
smoothmap(directory+'HFI_SkyMap_143_2048_R2.02_full.fits',directory+'256_60.00smoothed_PlanckR2fullbeam_143_2048_2015_KCMBunits.fits', output_resolution,nside_out=output_nside,outputmaps=[0,4],windowfunction=beamtf_p143)
smoothmap(directory+'HFI_SkyMap_217_2048_R2.02_full.fits',directory+'256_60.00smoothed_PlanckR2fullbeam_217_2048_2015_KCMBunits.fits', output_resolution,nside_out=output_nside,outputmaps=[0,4],windowfunction=beamtf_p217)
smoothmap(directory+'HFI_SkyMap_353_2048_R2.02_full.fits',directory+'256_60.00smoothed_PlanckR2fullbeam_353_2048_2015_KCMBunits.fits', output_resolution,nside_out=output_nside,outputmaps=[0,4],windowfunction=beamtf_p353)
smoothmap(directory+'HFI_SkyMap_545_2048_R2.02_full.fits',directory+'256_60.00smoothed_PlanckR2fullbeam_545_2048_2015_MJySrunits.fits', output_resolution,nside_out=output_nside,outputmaps=[0,2],windowfunction=beamtf_p545)
smoothmap(directory+'HFI_SkyMap_857_2048_R2.02_full.fits',directory+'256_60.00smoothed_PlanckR2fullbeam_857_2048_2015_MJySrunits.fits', output_resolution,nside_out=output_nside,outputmaps=[0,2],windowfunction=beamtf_p857)
