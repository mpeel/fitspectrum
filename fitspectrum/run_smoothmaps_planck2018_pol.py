...
for i in range(0,numnside):
	...
	for j in range(0,numsubtract):
		...
		smoothmap(directory,outdirectory,'HFI_SkyMap_100_2048_R3.01_full.fits',str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam'+subtractmaps_name[j]+'_100_2048_2018_mKCMBunits.fits', output_resolution,nside_out=output_nside[i],windowfunction=beamtf_p100,units_out='mKCMB',subtractmap=subtractmaps[j])#,maxnummaps=1,appendmap=directory+str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam_100_1024_2018_mKCMBunits_variance.fits',appendmapname="II_cov",appendmapunit="(mK)^2")
		smoothmap(directory,outdirectory,'HFI_SkyMap_143_2048_R3.01_full.fits',str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam'+subtractmaps_name[j]+'_143_2048_2018_mKCMBunits.fits', output_resolution,nside_out=output_nside[i],windowfunction=beamtf_p143,units_out='mKCMB',subtractmap=subtractmaps[j])#,maxnummaps=1,appendmap=directory+str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam_143_1024_2018_mKCMBunits_variance.fits',appendmapname="II_cov",appendmapunit="(mK)^2"
		smoothmap(directory,outdirectory,'HFI_SkyMap_217_2048_R3.01_full.fits',str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam'+subtractmaps_name[j]+'_217_2048_2018_mKCMBunits.fits', output_resolution,nside_out=output_nside[i],windowfunction=beamtf_p217,maxnummaps=1,appendmap=directory+str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam_217_1024_2018_mKCMBunits_variance.fits',appendmapname="II_cov",appendmapunit="(mK)^2",units_out='mKCMB',subtractmap=subtractmaps[j])
		smoothmap(directory,outdirectory,'HFI_SkyMap_353-psb_2048_R3.01_full.fits',str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam'+subtractmaps_name[j]+'_353_2048_2018_mKCMBunits.fits', output_resolution,nside_out=output_nside[i],windowfunction=beamtf_p353,maxnummaps=1,appendmap=directory+str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam_353_1024_2018_mKCMBunits_variance.fits',appendmapname="II_cov",appendmapunit="(mK)^2",units_out='mKCMB',subtractmap=subtractmaps[j])
		if j == 5:
			smoothmap(directory,outdirectory,'HFI_SkyMap_545_2048_R3.01_full.fits',str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam'+subtractmaps_name[j]+'_545_2048_2018_MJySrunits.fits', output_resolution,nside_out=output_nside[i],windowfunction=beamtf_p545,maxnummaps=1,appendmap=directory+str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam_545_1024_2018_MJySrunits_variance.fits',appendmapname="II_cov",appendmapunit="(MJySr)^2")
			smoothmap(directory,outdirectory,'HFI_SkyMap_857_2048_R3.01_full.fits',str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam'+subtractmaps_name[j]+'_857_2048_2018_MJySrunits.fits', output_resolution,nside_out=output_nside[i],windowfunction=beamtf_p857,maxnummaps=1,appendmap=directory+str(output_nside[i])+'_60.00smoothed_PlanckR3fullbeam_857_1024_2018_MJySrunits_variance.fits',appendmapname="II_cov",appendmapunit="(MJySr)^2")
