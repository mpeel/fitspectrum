...
outdirectory = directory+"wmap9_planck2018_tqu_v1.4/"
...
for i in range(0,numnside):
	# Smooth CMB maps
	# smoothmap(directory+'planck2018/',directory+'planck2018/','COM_CMB_IQU-commander_2048_R3.00_full.fits',str(output_nside[i])+'_'+str(output_resolution)+'smoothed_PlanckCMBCommander_0.0_2048_2018_mKCMBunits.fits', np.sqrt(output_resolution**2-5.0**2),nside_out=output_nside[i],units_out='mKCMB')
	# smoothmap(directory+'planck2018/',directory+'planck2018/','COM_CMB_IQU-nilc_2048_R3.00_full.fits',str(output_nside[i])+'_'+str(output_resolution)+'smoothed_PlanckCMBNILC_0.0_2048_2018_mKCMBunits.fits', np.sqrt(output_resolution**2-5.0**2),nside_out=output_nside[i],units_out='mKCMB')
	# smoothmap(directory+'planck2018/',directory+'planck2018/','COM_CMB_IQU-sevem_2048_R3.00_full.fits',str(output_nside[i])+'_'+str(output_resolution)+'smoothed_PlanckCMBSevem_0.0_2048_2018_mKCMBunits.fits', np.sqrt(output_resolution**2-5.0**2),nside_out=output_nside[i],units_out='mKCMB')
	# smoothmap(directory+'planck2018/',directory+'planck2018/','COM_CMB_IQU-smica_2048_R3.00_full.fits',str(output_nside[i])+'_'+str(output_resolution)+'smoothed_PlanckCMBSmica_0.0_2048_2018_mKCMBunits.fits', np.sqrt(output_resolution**2-5.0**2),nside_out=output_nside[i],units_out='mKCMB')
	# smoothmap(directory+'planck2018/',directory+'planck2018/','COM_CMB_IQU-smica-nosz_2048_R3.00_full.fits',str(output_nside[i])+'_'+str(output_resolution)+'smoothed_PlanckCMBSmica-nosz_0.0_2048_2018_mKCMBunits.fits', np.sqrt(output_resolution**2-5.0**2),nside_out=output_nside[i],units_out='mKCMB')

	# subtractmaps = [str(output_nside[i])+'_'+str(output_resolution)+'smoothed_PlanckCMBCommander_0.0_2048_2018_mKCMBunits.fits', str(output_nside[i])+'_'+str(output_resolution)+'smoothed_PlanckCMBNILC_0.0_2048_2018_mKCMBunits.fits', str(output_nside[i])+'_'+str(output_resolution)+'smoothed_PlanckCMBSevem_0.0_2048_2018_mKCMBunits.fits', str(output_nside[i])+'_'+str(output_resolution)+'smoothed_PlanckCMBSmica_0.0_2048_2018_mKCMBunits.fits', str(output_nside[i])+'_'+str(output_resolution)+'smoothed_PlanckCMBSmica-nosz_0.0_2048_2018_mKCMBunits.fits','']
	...
	for j in range(0,numsubtract):
		...
		if output_nside[i] <= 512:
			smoothmap(directory+'wmap9/',outdirectory,'wmap_band_iqumap_r9_9yr_K_v5.fits',str(output_nside[i])+'_'+str(output_resolution)+'smoothed_wmap9beam'+subtractmaps_name[j]+'_22.8_512_20132018_mKCMBunits.fits', output_resolution,nside_out=output_nside[i],sigma_0=1.429,sigma_0_unit='mK',windowfunction=beamtf_K,subtractmap=subtractmaps[j],smoothvariance=smoothvariance)#,maxnummaps=1,appendmap=directory+str(output_nside[i])+'_60.00smoothed_wmap9beam_22.8_512_2013_mKCMBunits_variance.fits',appendmapname="II_cov",appendmapunit="(mK)^2"
			...
			smoothmap(directory+'wmap9/',outdirectory,'wmap_band_iqumap_r9_9yr_Q_v5.fits',str(output_nside[i])+'_'+str(output_resolution)+'smoothed_wmap9beam'+subtractmaps_name[j]+'_40.7_512_20132018_mKCMBunits.fits', output_resolution,nside_out=output_nside[i],sigma_0=2.188,sigma_0_unit='mK',windowfunction=beamtf_Q,subtractmap=subtractmaps[j],smoothvariance=smoothvariance)#,maxnummaps=1,appendmap=directory+str(output_nside[i])+'_60.00smoothed_wmap9beam_40.7_512_2013_mKCMBunits_variance.fits',appendmapname="II_cov",appendmapunit="(mK)^2"
			...
			smoothmap(directory+'wmap9/',outdirectory,'wmap_band_iqumap_r9_9yr_W_v5.fits',str(output_nside[i])+'_'+str(output_resolution)+'smoothed_wmap9beam'+subtractmaps_name[j]+'_93.5_512_20132018_mKCMBunits.fits', output_resolution,nside_out=output_nside[i],sigma_0=6.544,sigma_0_unit='mK',windowfunction=beamtf_W,subtractmap=subtractmaps[j],smoothvariance=smoothvariance)#,maxnummaps=1,appendmap=directory+str(output_nside[i])+'_60.00smoothed_wmap9beam_93.5_512_2013_mKCMBunits_variance.fits',appendmapname="II_cov",appendmapunit="(mK)^2"
